...
# venv: compas-cra
# r: compas_cra>=0.7.2
"""Short cube stack with curved interfaces: CRA equilibrium, drawn into the Rhino document.

Rhino port of docs/examples/14_cube-curve-short.py. Keep rhino_cra_view.py next to this
...
cra_view_rhino(
    ...
    scale=50,
    density=density,
    layer_prefix="CRA-CubeCurveShort",
)
